    ...
    return (  
        ...
        <div className="login-page">
            <Form onSubmit={authenticate} className="login-form">
                ...
                <Button variant={isActive ? "dark" : "warning"} type="submit" id="loginBtn" disabled={!isActive}>
                    Login
                </Button>

                <p className="mt-3">Don't have an account? <Link to="/register" style={{ color: '#001f3f' }}>Register now</Link></p>
            </Form>      
        </div>
    );
}
